...
public class BusinessEntering extends BaseWebDriver{
...
//	保费
	@FindBy(name="insuranceInfoDetailList[0].insuranceFee")
	private WebElement insuranceFee;
	
//	保额
	@FindBy(name="insuranceInfoDetailList[0].insuranceMoney")
