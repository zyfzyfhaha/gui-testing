...
public class BranchCompanyFinanceManagerPage extends BaseWebDriver{

//	全额回款按钮
	@FindBy(id="payeeMethod_2")
	private WebElement payAll_radioBtn;
...
// 选择全额回款
	public void selectPayAll(String payMethodString)throws Throwable{
		Thread.sleep(2000);
		driver.switchTo().defaultContent();
		driver.switchTo().frame("iframe_undefined");
		if(payMethodString.equals("全额回款")){
			payAll_radioBtn.click();
		}
	}
