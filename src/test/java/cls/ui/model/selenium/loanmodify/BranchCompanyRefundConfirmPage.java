...
public class BranchCompanyRefundConfirmPage extends BaseWebDriver{

//	付款说明
	@FindBy(xpath="//*[@id='paymentGetForm2']/div[1]/div[2]/div[4]/div/div/textarea")
	private WebElement payExplanation_textBox;
...
//	输入付款说明
	public void enterPayExplanation(String payExplanationString)throws Throwable{
		Thread.sleep(2000);
		payExplanation_textBox.clear();
		payExplanation_textBox.sendKeys(payExplanationString);
	}	
