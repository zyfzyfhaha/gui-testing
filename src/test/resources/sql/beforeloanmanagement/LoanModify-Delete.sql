...
DELETE FROM cls.business_object_process_info WHERE business_type IN ('LOAN_APPLY_FLOW','LOAN_MODIFY_FLOW') AND business_object_id IN (SELECT id FROM cls.loan_apply WHERE id = '@parameter') ;#
