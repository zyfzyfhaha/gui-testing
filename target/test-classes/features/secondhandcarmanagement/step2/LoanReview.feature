...
Feature: Loan Review
  ...
  Scenario: AC1: Normal process for loan review
    ...
    And Enter second hand car customer details in StartLoan page
      | businessType | product | carType | isDiscount | detailBrand | carSeries | carModel          | isImport | carDealer | carFee  | billingPrice | loanPrice | handingFee | province | city | area | address   |
      | 信用卡贷款(普通模式)  | 自动化测试专用 | 二手车     | 否          | 奥迪          | 奥迪A1      | 2014款 30 TFSI 技术型 | 否        | 自动化测试车行   | 自动化测试费用 |       300000 |    250000 |         15 | 浙江省      | 杭州市  | 西湖区  | 浙商财富中心3号楼 |
    ...
    When Enter basic details in Business Entering page
      ...
      | 2019-12-31      | 测试派出所                   | 浙江杭州        | 13588840001 | 自有住房          | 本科        | 职员             | 科员及职员 | 医疗行业     | 民企             | 5000-9999     |       150000 | 3年以上              | 1-500         | 3年以上       | 车国          |  15868470001 | 2015-12-31 | 浙江省             | 杭州市         | 西湖区         | 浙商财富中心3号楼            | 浙江省          | 杭州市      | 西湖区      | 2015-12-31     | 浙商财富中心            | 否        | 同意          | 业务录入-测试同意 |
    And Add emergency contracts in Business Entering page
      ...
      | uiTest012     | 父亲                    |    13588840002 | 否                  |
      | uiTest013     | 母亲                    |    13588840003 | 否                  |
    And Enter budget details in Business Entering page
      | isPublicLicense | paymentMethod | deliveryMethod | collectedAmount |
      | 否               | 全额打款          | 现金             |            1000 |
